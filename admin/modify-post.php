 ...
 * = MODIFY-POST.PHP
 *
 * THE PHP FILE FOR MODIFYING THE GIVEN POST WITH ALL OF ITS DATA.
 *
 * ------------------------------------------------------------------------- -->
<?php
...
require_once("../util/modify-post-util.php")
?>
<!DOCTYPE html>
<html lang="en">

<head>
	<title>Admin Interface | Modify Post With It's Picture</title>
...
<body>
	<div class="admin-main-div">
		...
		<div class="admin-new-post-div">
			<h2 class="admin-post-h2">MODIFY POST WITH ITS PICTURE</h2>
			<?php
			...
			?>
				<form method="post" enctype="multipart/form-data">
					...
					<div class="prev-post-img">
						<h3>Previous post image</h3>
						<img src="<?php echo htmlentities($row['post_img']); ?>" alt="previous img" class="modify-prev-img">
						<p>(<?php echo substr(htmlentities($row['post_img']), 6); ?>)</p>
					</div>
				<?php } ?>
				<div class="admin-submit-notice">
					...
					<ul>
						...
						<li>New post image, the old picture will be deleted.</li>
					</ul>
